...
def handle_dialog(res, req):
    ...
    if req['session']['new']:
        res['response'][
            'text'] = 'ÐŸÑ€Ð¸Ð²ÐµÑ‚! Ð¯ Ð¼Ð¾Ð³Ñƒ ÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð² ÐºÐ°ÐºÐ¾Ð¹ ÑÑ‚Ñ€Ð°Ð½Ðµ Ð³Ð¾Ñ€Ð¾Ð´ Ð¸Ð»Ð¸ ÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ñ€Ð°ÑÑÑ‚Ð¾ÑÐ½Ð¸Ðµ Ð¼ÐµÐ¶Ð´Ñƒ Ð³Ð¾Ñ€Ð¾Ð´Ð°Ð¼Ð¸!'
    ...
    if len(cities) == 0:
        ...
        res['response']['text'] = 'Ð Ð°ÑÑÑ‚Ð¾ÑÐ½Ð¸Ðµ Ð¼ÐµÐ¶Ð´Ñƒ ÑÑ‚Ð¸Ð¼Ð¸ Ð³Ð¾Ñ€Ð¾Ð´Ð°Ð¼Ð¸: ' + str(
            round(distance)) + ' ÐºÐ¼.'
